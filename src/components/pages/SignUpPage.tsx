...
const SignUpPage: FC = () => {
    const {register, handleSubmit, reset, formState: {errors}} = useForm<SignUpFields>()
    ...
    return (
        <>
            <MContainer maxWidth="lg" sx={{
                ...
                }} variants={typographyVariants} custom={0}>Sign up</MTypography>
                <MTypography variant="h6" fontFamily="inherit" fontWeight={400} align="center" sx={{
                    ...
                    mb: {
                        ...
                        md: 6,
                             ...
                             variants={typographyVariants} custom={1}>Fill all field for create an
                    account.</MTypography>
                <Box component="form" onSubmit={handleSubmit(onSubmit)}>
                    <MStack rowGap={4} sx={{
                        ...
                        <MBox sx={{
                            ...
                            <GreyInput type="text" placeholder="Email Address" variant="standard" fullWidth
                                       {...register("email", {
                                           required: {
                                               value: true,
                    ...
                    <MStack rowGap={4} sx={{
                        ...
                        }} variants={typographyVariants} custom={4}>
                        ...
                        }} initial="hidden" whileInView="visible" variants={buttonVariants} custom={4}>Sign Up</MButton>
                    </MStack>
                </Box>
                ...
                }} initial="hidden" whileInView="visible" variants={typographyVariants} custom={0.2}>Sign up
                    with...</MTypography>
